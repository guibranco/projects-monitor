...
class CPanel
{
     ...
     * @param action The `action` parameter in the `getRequest` function represents the specific action
     * or operation that you want to perform within the specified module. It could be a CRUD operation
     * (Create, Read, Update, Delete) or any other action that the module supports. This parameter
     * helps in constructing the URL for the
