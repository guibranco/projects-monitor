...
<body>
   ...
   <div style="clear:both;"></div>
   <div id="messages_grouped" style="width: 100%; height: 500px; background-color: white;"></div>
    <div style="clear:both;"></div>
   <div id="error_log_messages" style="width: 100%; height: 500px; background-color: white;"></div>
   <div style="clear:both;"></div>
